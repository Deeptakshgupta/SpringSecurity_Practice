...
public class Client {
  ...
  // creating custom mapping to convert the Registered Client into Client
  public static Client from(RegisteredClient registeredClient) {
    ...
    client.setRedirectUri(    // NOT CLEAN CODE =>as list of Uri's must be present and we are using only one for time being, using findAny() provided by the Streams	
  ...
  // creating custom mapping to convert the Client into Registered Client
